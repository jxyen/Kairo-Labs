...
function buildPrompt(name, mg, slug) {
  ...
  return `Recreate the attached KAIRO LABS research-vial product photo EXACTLY — this is a consistent product LINE, so the bottle must look identical to the reference. Keep the SAME glass vial shape and size, the SAME ribbed black-and-gunmetal flip-off cap, the SAME label layout and proportions, the SAME molecule-hexagon + "K" KAIRO LABS logo at the top of the label, the SAME clean flat-WHITE bold brand sans-serif (Switzer-style) for the product name, the SAME emerald dose styling, the SAME "RESEARCH PURPOSES ONLY / NOT FOR HUMAN CONSUMPTION" and "LAB TESTED • VERIFIED PURITY" lines, the SAME tight framing (vial fills the frame), lighting, reflection and pure-black background. Strict palette: black + white + grey + electric spring-emerald #35E0A0 only.
